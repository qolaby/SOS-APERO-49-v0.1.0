...
const MessageExampleAttached = () => (
  <div>
    ...
    <Form className='attached fluid segment'>
      ...
      <Form.Input label='Email' placeholder='Votre email' type='text' />
      <Form.Input label='Password' type='password'placeholder='Chuuut! votre mot de passe par içi'/>
      <Form.Checkbox inline label='J&#39;accepte les conditions d&#39;utilisation' required/>
